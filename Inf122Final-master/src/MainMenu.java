...
public class MainMenu extends JFrame{
	...
	void setGamesPanel(){
		...
		JButton recordButton = new JButton("User Stats");
	...
	void recordButtonPressed(){
		System.out.println("User stats button pressed");
		Driver.user1 = Driver.getUser(p1t.getText());
		Driver.user2 = Driver.getUser(p2t.getText());
		StatsGUI stats = new StatsGUI(Driver.user1, Driver.user2);
	}
